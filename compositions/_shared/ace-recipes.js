/**
 * Shared documentary motion helpers (deterministic bursts, no Math.random).
 * Exposes `window.Ace435` for ACE-435 and other ace-documentary compositions.
 */
(function (global) {
  ...
  function snapZoomWithRecover(tl, heroEl, time, opts) {
    ...
    const pz = o.peakZ != null ? o.peakZ : 120;
    const pd = o.peakDur != null ? o.peakDur : 0.18;
    const rd = o.recoverDur != null ? o.recoverDur : 0.5;
    tl.fromTo(
      heroEl,
      { scale: 1, z: 0 },
